...
const posts = [
  {
    ...
    content: [
      { type: "paragraph", content: "Fala galeraa 👋" },
      {
        type: "paragraph",
        content:
          "Acabei de subir mais um projeto no meu portfólio. Projeto do curso de React JS da Rocketseat.🚀",
      },
      { type: "link", content: "👉 developerismaellucas.com" },
  ...
  },
  {
    ...
    content: [
      { type: "paragraph", content: "eai Jovens 👋" },
      {
        type: "paragraph",
        content:
          "Acabei de subir mais um projeto no meu Github. É um projeto que fiz no NLW Return, evento da Rocketseat.",
      },
      { type: "link", content: "#novoprojeto" },
  ...
  },
  {
    ...
    content: [
      { type: "paragraph", content: "eai reis e rainhas 👋" },
      {
        type: "paragraph",
        content:
          "Acabei de subir mais um projeto no meu portifa sobre banco de dados.",
      },
