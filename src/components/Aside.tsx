...
function Aside() {
  return (
    <aside className="bg-gray-80 rounded-lg overflow-hidden">
      ...
      />
      <div className="flex flex-col items-center font-roboto mb-8">
        <ImgProfile
          extraClass="out mt-[calc(0px-1.5rem-6px)]"
          src="https://avatars.githubusercontent.com/u/76995730?v=4"
        />
        <strong className="mt-4 text-gray-10 leading-[1.6]">
          Ismael Lucas
        </strong>
        <span className="text-[0.875rem] text-gray-40 leading-[1.6]">
          Desenvolvedor Front-end
        </span>
      </div>

      <footer className="border-t border-gray-60 mt-6 pt-6 px-6 pb-8 hidden">
        <a
